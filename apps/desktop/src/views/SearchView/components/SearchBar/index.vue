...
<template>
    <div
        ...
        class="search-bar-container relative flex min-h-14 w-full items-center gap-2 p-3 transition-all duration-250 ease-in-out"
    ...
    >
        ...
        <div
            ...
            class="search-bar-editor-host custom-scrollbar-thin flex min-h-6 flex-1 cursor-default overflow-y-auto"
            :class="[
